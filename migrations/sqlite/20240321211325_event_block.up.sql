...
CREATE TABLE IF NOT EXISTS event_block (
    event_id BLOB NOT NULL, -- network_id sort_value controller StreamID height event_cid
    block_cid BLOB NOT NULL, -- the cid of the Block as bytes no 0x00 prefix
    ...
    PRIMARY KEY(event_id, block_cid),
