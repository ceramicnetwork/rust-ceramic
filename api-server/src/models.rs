...
impl AccessTokenRequest {
    ...
    pub fn new() -> AccessTokenRequest {
        AccessTokenRequest { request_id: None }
    }
}

/// Converts the AccessTokenRequest value to the Query Parameters representation (style=form, explode=false)
/// specified in https://swagger.io/docs/specification/serialization/
/// Should be implemented in a serde serializer
impl std::string::ToString for AccessTokenRequest {
    fn to_string(&self) -> String {
        let params: Vec<Option<String>> = vec![self
            .request_id
            .as_ref()
            .map(|request_id| ["requestId".to_string(), request_id.to_string()].join(","))];

        params.into_iter().flatten().collect::<Vec<_>>().join(",")
    }
}

/// Converts Query Parameters representation (style=form, explode=false) to a AccessTokenRequest value
/// as specified in https://swagger.io/docs/specification/serialization/
/// Should be implemented in a serde deserializer
impl std::str::FromStr for AccessTokenRequest {
    type Err = String;
    ...
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        ...
        while key_result.is_some() {
            let val = match string_iter.next() {
                ...
                None => {
                    return std::result::Result::Err(
                        "Missing value while parsing AccessTokenRequest".to_string(),
                    )
                }
            };
            ...
            if let Some(key) = key_result {
                ...
                match key {
                    ...
                    _ => {
                        return std::result::Result::Err(
                            "Unexpected key while parsing AccessTokenRequest".to_string(),
                        )
                    }
                }
            }
        ...
        std::result::Result::Ok(AccessTokenRequest {
            request_id: intermediate_rep.request_id.into_iter().next(),
        })
    }
}

// Methods for converting between header::IntoHeaderValue<AccessTokenRequest> and hyper::header::HeaderValue

#[cfg(any(feature = "client", feature = "server"))]
impl std::convert::TryFrom<header::IntoHeaderValue<AccessTokenRequest>>
    for hyper::header::HeaderValue
{
    type Error = String;

    fn try_from(
        hdr_value: header::IntoHeaderValue<AccessTokenRequest>,
    ) -> std::result::Result<Self, Self::Error> {
        let hdr_value = hdr_value.to_string();
        match hyper::header::HeaderValue::from_str(&hdr_value) {
            std::result::Result::Ok(value) => std::result::Result::Ok(value),
            std::result::Result::Err(e) => std::result::Result::Err(format!(
                "Invalid header value for AccessTokenRequest - value: {} is invalid {}",
                hdr_value, e
            )),
        }
    }
...
impl std::convert::TryFrom<hyper::header::HeaderValue>
    for header::IntoHeaderValue<AccessTokenRequest>
{
    type Error = String;
    ...
    fn try_from(hdr_value: hyper::header::HeaderValue) -> std::result::Result<Self, Self::Error> {
        match hdr_value.to_str() {
            std::result::Result::Ok(value) => {
                match <AccessTokenRequest as std::str::FromStr>::from_str(value) {
                    std::result::Result::Ok(value) => {
                        std::result::Result::Ok(header::IntoHeaderValue(value))
                    }
                    std::result::Result::Err(err) => std::result::Result::Err(format!(
                        "Unable to convert header value '{}' into AccessTokenRequest - {}",
                        value, err
                    )),
                }
            }
...
impl RefreshTokenRequest {
    ...
    pub fn new() -> RefreshTokenRequest {
        RefreshTokenRequest { request_id: None }
    }
}

/// Converts the RefreshTokenRequest value to the Query Parameters representation (style=form, explode=false)
/// specified in https://swagger.io/docs/specification/serialization/
/// Should be implemented in a serde serializer
impl std::string::ToString for RefreshTokenRequest {
    fn to_string(&self) -> String {
        let params: Vec<Option<String>> = vec![self
            .request_id
            .as_ref()
...
/// Converts Query Parameters representation (style=form, explode=false) to a RefreshTokenRequest value
/// as specified in https://swagger.io/docs/specification/serialization/
/// Should be implemented in a serde deserializer
impl std::str::FromStr for RefreshTokenRequest {
    type Err = String;
    ...
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        ...
        while key_result.is_some() {
            let val = match string_iter.next() {
                ...
                None => {
                    return std::result::Result::Err(
                        "Missing value while parsing RefreshTokenRequest".to_string(),
                    )
                }
            };
            ...
            if let Some(key) = key_result {
                ...
                match key {
                    ...
                    _ => {
                        return std::result::Result::Err(
                            "Unexpected key while parsing RefreshTokenRequest".to_string(),
                        )
                    }
                }
            }
        ...
        // Use the intermediate representation to return the struct
        std::result::Result::Ok(RefreshTokenRequest {
            request_id: intermediate_rep.request_id.into_iter().next(),
        })
    }
}

// Methods for converting between header::IntoHeaderValue<RefreshTokenRequest> and hyper::header::HeaderValue

#[cfg(any(feature = "client", feature = "server"))]
impl std::convert::TryFrom<header::IntoHeaderValue<RefreshTokenRequest>>
    for hyper::header::HeaderValue
{
    type Error = String;

    fn try_from(
        hdr_value: header::IntoHeaderValue<RefreshTokenRequest>,
    ) -> std::result::Result<Self, Self::Error> {
        let hdr_value = hdr_value.to_string();
        match hyper::header::HeaderValue::from_str(&hdr_value) {
            std::result::Result::Ok(value) => std::result::Result::Ok(value),
            std::result::Result::Err(e) => std::result::Result::Err(format!(
                "Invalid header value for RefreshTokenRequest - value: {} is invalid {}",
                hdr_value, e
            )),
        }
    }
...
#[cfg(any(feature = "client", feature = "server"))]
impl std::convert::TryFrom<hyper::header::HeaderValue>
    for header::IntoHeaderValue<RefreshTokenRequest>
{
    type Error = String;
    ...
    fn try_from(hdr_value: hyper::header::HeaderValue) -> std::result::Result<Self, Self::Error> {
        match hdr_value.to_str() {
            std::result::Result::Ok(value) => {
                match <RefreshTokenRequest as std::str::FromStr>::from_str(value) {
                    std::result::Result::Ok(value) => {
                        std::result::Result::Ok(header::IntoHeaderValue(value))
                    }
                    std::result::Result::Err(err) => std::result::Result::Err(format!(
                        "Unable to convert header value '{}' into RefreshTokenRequest - {}",
                        value, err
                    )),
                }
            }
