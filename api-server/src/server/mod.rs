            ...
            C: Has<XSpanIdString> + Send + Sync + 'static,
        {
            ...
            match method {
                ...
                hyper::Method::OPTIONS if path.matched(paths::ID_DEBUG_HEAP) => {
                    ...
                    match result {
                        Ok(rsp) => match rsp {
                            DebugHeapOptionsResponse::CORSHeaders {
                                access_control_allow_origin,
                                access_control_allow_methods,
                                access_control_allow_headers,
                            } => {
                                if let Some(access_control_allow_origin) =
                                    access_control_allow_origin
                                {
                                ...
                                if let Some(access_control_allow_methods) =
                                    access_control_allow_methods
                                {
                                ...
                                if let Some(access_control_allow_headers) =
                                    access_control_allow_headers
                                {
                ...
                hyper::Method::OPTIONS if path.matched(paths::ID_EVENTS_EVENT_ID) => {
                    ...
                    match result {
                        Ok(rsp) => match rsp {
                            EventsEventIdOptionsResponse::CORSHeaders {
                                access_control_allow_origin,
                                access_control_allow_methods,
                                access_control_allow_headers,
                            } => {
                ...
                hyper::Method::OPTIONS if path.matched(paths::ID_EVENTS) => {
                    ...
                    match result {
                        Ok(rsp) => match rsp {
                            EventsOptionsResponse::CORSHeaders {
                                access_control_allow_origin,
                                access_control_allow_methods,
                                access_control_allow_headers,
                            } => {
                    ...
                    if path.matched(paths::ID_EXPERIMENTAL_EVENTS_SEP_SEPVALUE) =>
                {
                    ...
                    match result {
                        Ok(rsp) => match rsp {
                            ExperimentalEventsSepSepValueOptionsResponse::CORSHeaders {
                                access_control_allow_origin,
                                access_control_allow_methods,
                                access_control_allow_headers,
                            } => {
                ...
                hyper::Method::OPTIONS if path.matched(paths::ID_EXPERIMENTAL_INTERESTS) => {
                    ...
                    match result {
                        Ok(rsp) => match rsp {
                            ExperimentalInterestsOptionsResponse::CORSHeaders {
                                access_control_allow_origin,
                                access_control_allow_methods,
                                access_control_allow_headers,
                            } => {
                ...
                hyper::Method::OPTIONS if path.matched(paths::ID_FEED_EVENTS) => {
                    ...
                    match result {
                        Ok(rsp) => match rsp {
                            FeedEventsOptionsResponse::CORSHeaders {
                                access_control_allow_origin,
                                access_control_allow_methods,
                                access_control_allow_headers,
                            } => {
                ...
                hyper::Method::OPTIONS if path.matched(paths::ID_FEED_RESUMETOKEN) => {
                    ...
                    match result {
                        Ok(rsp) => match rsp {
                            FeedResumeTokenOptionsResponse::CORSHeaders {
                                access_control_allow_origin,
                                access_control_allow_methods,
                                access_control_allow_headers,
                            } => {
                ...
                hyper::Method::OPTIONS if path.matched(paths::ID_INTERESTS) => {
                    ...
                    match result {
                        Ok(rsp) => match rsp {
                            InterestsOptionsResponse::CORSHeaders {
                                access_control_allow_origin,
                                access_control_allow_methods,
                                access_control_allow_headers,
                            } => {
                ...
                hyper::Method::OPTIONS if path.matched(paths::ID_INTERESTS_SORT_KEY_SORT_VALUE) => {
                    ...
                    match result {
                        Ok(rsp) => match rsp {
                            InterestsSortKeySortValueOptionsResponse::CORSHeaders {
                                access_control_allow_origin,
                                access_control_allow_methods,
                                access_control_allow_headers,
                            } => {
                ...
                hyper::Method::OPTIONS if path.matched(paths::ID_LIVENESS) => {
                    ...
                    match result {
                        Ok(rsp) => match rsp {
                            LivenessOptionsResponse::CORSHeaders {
                                access_control_allow_origin,
                                access_control_allow_methods,
                                access_control_allow_headers,
                            } => {
                ...
                hyper::Method::OPTIONS if path.matched(paths::ID_VERSION) => {
                    ...
                    match result {
                        Ok(rsp) => match rsp {
                            VersionOptionsResponse::CORSHeaders {
                                access_control_allow_origin,
                                access_control_allow_methods,
                                access_control_allow_headers,
                            } => {
