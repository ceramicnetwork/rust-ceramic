...
impl SqliteEventStore {
    ...
    async fn keys_with_missing_values_int(&self, range: Range<&EventId>) -> Result<Vec<EventId>> {
...
impl recon::Store for SqliteEventStore {
    ...
    #[instrument(skip(self))]
    async fn keys_with_missing_values(&self, range: Range<&EventId>) -> ReconResult<Vec<EventId>> {
