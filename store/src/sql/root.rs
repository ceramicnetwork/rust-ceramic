...
use crate::{PostgresPool, SqlitePool};
...
/// See `RootStoreSqlite` for more information.
#[derive(Debug, Clone)]
pub struct RootStorePostgres {
    pool: PostgresPool,
}

impl RootStorePostgres {
    /// Create a new RootStore for Postgres
