...
#define SWIGTYPE_p_uint swig_types[2]
...
SWIGV8_ClientData _exports_Bytes_clientData;


static void _wrap_Bytes_data_set(v8::Local<v8::Name> property, v8::Local<v8::Value> value, const SwigV8PropertyCallbackInfoVoid &info) {
  SWIGV8_HANDLESCOPE();
  ...
  res1 = SWIG_ConvertPtr(info.Holder(), &argp1,SWIGTYPE_p_Bytes, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "Bytes_data_set" "', argument " "1"" of type '" "Bytes *""'"); 
  }
  arg1 = reinterpret_cast< Bytes * >(argp1);
  res2 = SWIG_AsCharPtrAndSize(value, &buf2, NULL, &alloc2);
  if (!SWIG_IsOK(res2)) {
    SWIG_exception_fail(SWIG_ArgError(res2), "in method '" "Bytes_data_set" "', argument " "2"" of type '" "char *""'");
  }
...
static SwigV8ReturnValue _wrap_Bytes_data_get(v8::Local<v8::Name> property, const SwigV8PropertyCallbackInfo &info) {
  SWIGV8_HANDLESCOPE();
  ...
  res1 = SWIG_ConvertPtr(info.Holder(), &argp1,SWIGTYPE_p_Bytes, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "Bytes_data_get" "', argument " "1"" of type '" "Bytes *""'"); 
  }
  arg1 = reinterpret_cast< Bytes * >(argp1);
...
static void _wrap_Bytes_len_set(v8::Local<v8::Name> property, v8::Local<v8::Value> value, const SwigV8PropertyCallbackInfoVoid &info) {
  SWIGV8_HANDLESCOPE();
  ...
  res1 = SWIG_ConvertPtr(info.Holder(), &argp1,SWIGTYPE_p_Bytes, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "Bytes_len_set" "', argument " "1"" of type '" "Bytes *""'"); 
  }
  arg1 = reinterpret_cast< Bytes * >(argp1);
  {
    res2 = SWIG_ConvertPtr(value, &argp2, SWIGTYPE_p_uint,  0 );
    if (!SWIG_IsOK(res2)) {
      SWIG_exception_fail(SWIG_ArgError(res2), "in method '" "Bytes_len_set" "', argument " "2"" of type '" "uint""'"); 
    }  
    if (!argp2) {
      SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "Bytes_len_set" "', argument " "2"" of type '" "uint""'");
    } else {
...
static SwigV8ReturnValue _wrap_Bytes_len_get(v8::Local<v8::Name> property, const SwigV8PropertyCallbackInfo &info) {
  SWIGV8_HANDLESCOPE();
  ...
  res1 = SWIG_ConvertPtr(info.Holder(), &argp1,SWIGTYPE_p_Bytes, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "Bytes_len_get" "', argument " "1"" of type '" "Bytes *""'"); 
  }
  arg1 = reinterpret_cast< Bytes * >(argp1);
  result =  ((arg1)->len);
  jsresult = SWIG_NewPointerObj((new uint(result)), SWIGTYPE_p_uint, SWIG_POINTER_OWN |  0 );
...
static SwigV8ReturnValue _wrap_new_Bytes(const SwigV8Arguments &args) {
  SWIGV8_HANDLESCOPE();
  
  SWIGV8_OBJECT self = args.Holder();
  Bytes *result;
  if(self->InternalFieldCount() < 1) SWIG_exception_fail(SWIG_ERROR, "Illegal call of constructor _wrap_new_Bytes.");
  if(args.Length() != 0) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_new_Bytes.");
  result = (Bytes *)new Bytes();
  
  
  
  SWIGV8_SetPrivateData(self, result, SWIGTYPE_p_Bytes, SWIG_POINTER_OWN);
  SWIGV8_RETURN(self);
...
static void _wrap_delete_Bytes(const v8::WeakCallbackInfo<SWIGV8_Proxy> &data) {
  SWIGV8_Proxy *proxy = data.GetParameter();
  
  if(proxy->swigCMemOwn && proxy->swigCObject) {
    Bytes * arg1 = (Bytes *)proxy->swigCObject;
    delete arg1;
  }
  delete proxy;
}
...
static SwigV8ReturnValue _wrap_ceramic_kubo_dag_get(const SwigV8Arguments &args) {
  SWIGV8_HANDLESCOPE();
  ...
  if(args.Length() != 1) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_ceramic_kubo_dag_get.");
  
  res1 = SWIG_AsCharPtrAndSize(args[0], &buf1, NULL, &alloc1);
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "ceramic_kubo_dag_get" "', argument " "1"" of type '" "char *""'");
  }
  arg1 = reinterpret_cast< char * >(buf1);
  result = ceramic_kubo_dag_get(arg1);
  jsresult = SWIG_NewPointerObj((new Bytes(result)), SWIGTYPE_p_Bytes, SWIG_POINTER_OWN |  0 );
...
static swig_type_info _swigt__p_Bytes = {"_p_Bytes", "Bytes *|p_Bytes", 0, 0, (void*)0, 0};
...
#endif
{
  ...
  /* Name: _exports_Bytes, Type: p_Bytes, Dtor: _wrap_delete_Bytes */
SWIGV8_FUNCTION_TEMPLATE _exports_Bytes_class = SWIGV8_CreateClassTemplate("_exports_Bytes");
SWIGV8_SET_CLASS_TEMPL(_exports_Bytes_clientData.class_templ, _exports_Bytes_class);
_exports_Bytes_clientData.dtor = _wrap_delete_Bytes;
if (SWIGTYPE_p_Bytes->clientdata == 0) {
  SWIGTYPE_p_Bytes->clientdata = &_exports_Bytes_clientData;
}


  /* register wrapper functions */
  SWIGV8_AddMemberVariable(_exports_Bytes_class, "data", _wrap_Bytes_data_get, _wrap_Bytes_data_set);
SWIGV8_AddMemberVariable(_exports_Bytes_class, "len", _wrap_Bytes_len_get, _wrap_Bytes_len_set);
  ...
  /* class instances */
  /* Class: Bytes (_exports_Bytes) */
SWIGV8_FUNCTION_TEMPLATE _exports_Bytes_class_0 = SWIGV8_CreateClassTemplate("Bytes");
_exports_Bytes_class_0->SetCallHandler(_wrap_new_Bytes);
_exports_Bytes_class_0->Inherit(_exports_Bytes_class);
#if (SWIG_V8_VERSION < 0x0704)
_exports_Bytes_class_0->SetHiddenPrototype(true);
v8::Local<v8::Object> _exports_Bytes_obj = _exports_Bytes_class_0->GetFunction();
#else
v8::Local<v8::Object> _exports_Bytes_obj = _exports_Bytes_class_0->GetFunction(context).ToLocalChecked();
#endif


  /* add static class functions and variables */
  SWIGV8_AddStaticFunction(exports_obj, "ceramic_kubo_dag_get", _wrap_ceramic_kubo_dag_get, context);


  /* register classes */
  SWIGV8_MAYBE_CHECK(exports_obj->Set(context, SWIGV8_SYMBOL_NEW("Bytes"), _exports_Bytes_obj));
