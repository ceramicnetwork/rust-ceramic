...
async fn test_conclusion_events_since() -> Result<(), Box<dyn std::error::Error>> {
    ...
    expect![[r#"
        ...
        +-------+------------+---------------------------------------------------------------+-------------+----------------------------------------------------------+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+---------------------------------------------------------------+--------------------------------------------+----------------------------------------------------------------------+
        | 0     | Data       | bagcqcera2tgmzqn4bcgjqr56iyfxkm7k6nmkjl5t54bunwr3xrh2brucwfqa | 3           | did:key:z6Mkk3rtfoKDMMG4zyarNGwCQs44GSQ49pcYKQspHJPXSnVw | [model: "ce0102015512204bf5122f344554c53bde2ebb8cd2b7e3d1600ad631c385a5d7cce23c7785459a", controller: "6469643a6b65793a7a364d6b6b337274666f4b444d4d47347a7961724e4777435173343447535134397063594b517370484a5058536e5677", context: "", unique: "756e6971756531"] | bagcqcera2tgmzqn4bcgjqr56iyfxkm7k6nmkjl5t54bunwr3xrh2brucwfqa | 6e756c6c                                   | []                                                                   |
        +-------+------------+---------------------------------------------------------------+-------------+----------------------------------------------------------+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+---------------------------------------------------------------+--------------------------------------------+----------------------------------------------------------------------+
        | 1     | Data       | bagcqcera2tgmzqn4bcgjqr56iyfxkm7k6nmkjl5t54bunwr3xrh2brucwfqa | 3           | did:key:z6Mkk3rtfoKDMMG4zyarNGwCQs44GSQ49pcYKQspHJPXSnVw | [model: "ce0102015512204bf5122f344554c53bde2ebb8cd2b7e3d1600ad631c385a5d7cce23c7785459a", controller: "6469643a6b65793a7a364d6b6b337274666f4b444d4d47347a7961724e4777435173343447535134397063594b517370484a5058536e5677", context: "", unique: "756e6971756531"] | bagcqcera2kq4x22idnjrvbd4tvsumi7lnrbuyr27wsdr33kxydlxd6v6nirq | 7b2273747265616d5f31223a22646174615f31227d | [Cid(bagcqcera2tgmzqn4bcgjqr56iyfxkm7k6nmkjl5t54bunwr3xrh2brucwfqa)] |
        +-------+------------+---------------------------------------------------------------+-------------+----------------------------------------------------------+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+---------------------------------------------------------------+--------------------------------------------+----------------------------------------------------------------------+
        | 2     | Data       | bagcqcera2tgmzqn4bcgjqr56iyfxkm7k6nmkjl5t54bunwr3xrh2brucwfqa | 3           | did:key:z6Mkk3rtfoKDMMG4zyarNGwCQs44GSQ49pcYKQspHJPXSnVw | [model: "ce0102015512204bf5122f344554c53bde2ebb8cd2b7e3d1600ad631c385a5d7cce23c7785459a", controller: "6469643a6b65793a7a364d6b6b337274666f4b444d4d47347a7961724e4777435173343447535134397063594b517370484a5058536e5677", context: "", unique: "756e6971756531"] | bagcqceraqptbsxmznnnfrg5wz3tcudp34oumwmyqsngcjc4bwad7h7tcdbnq | 7b2273747265616d5f31223a22646174615f32227d | [Cid(bagcqcera2kq4x22idnjrvbd4tvsumi7lnrbuyr27wsdr33kxydlxd6v6nirq)] |
        +-------+------------+---------------------------------------------------------------+-------------+----------------------------------------------------------+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+---------------------------------------------------------------+--------------------------------------------+----------------------------------------------------------------------+
        | 3     | Data       | bagcqcera7676x76gw73otbz7l53gk2gjozzg2wztunc7ia2k722tofjecg3q | 2           | did:key:z6Mkk3rtfoKDMMG4zyarNGwCQs44GSQ49pcYKQspHJPXSnVw | [model: "ce01040171710b0009686d6f64656c2d7631", controller: "6469643a6b65793a7a364d6b6b337274666f4b444d4d47347a7961724e4777435173343447535134397063594b517370484a5058536e5677", context: "", unique: "756e6971756532"]                                           | bagcqcera7676x76gw73otbz7l53gk2gjozzg2wztunc7ia2k722tofjecg3q | 6e756c6c                                   | []                                                                   |
        +-------+------------+---------------------------------------------------------------+-------------+----------------------------------------------------------+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+---------------------------------------------------------------+--------------------------------------------+----------------------------------------------------------------------+
        | 4     | Data       | bagcqcera7676x76gw73otbz7l53gk2gjozzg2wztunc7ia2k722tofjecg3q | 2           | did:key:z6Mkk3rtfoKDMMG4zyarNGwCQs44GSQ49pcYKQspHJPXSnVw | [model: "ce01040171710b0009686d6f64656c2d7631", controller: "6469643a6b65793a7a364d6b6b337274666f4b444d4d47347a7961724e4777435173343447535134397063594b517370484a5058536e5677", context: "", unique: "756e6971756532"]                                           | bagcqcerakwru6hoab2zyav65no62coy4mxkdibg2godhgq42j7y6xlrmwfeq | 7b2273747265616d32223a22646174615f31227d   | [Cid(bagcqcera7676x76gw73otbz7l53gk2gjozzg2wztunc7ia2k722tofjecg3q)] |
        +-------+------------+---------------------------------------------------------------+-------------+----------------------------------------------------------+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+---------------------------------------------------------------+--------------------------------------------+----------------------------------------------------------------------+
