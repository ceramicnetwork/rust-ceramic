...
mod tests {
    ...
    const _SIGNED_INIT_EVENT_CID: &str =
        "bagcqcerar2aga7747dm6fota3iipogz4q55gkaamcx2weebs6emvtvie2oha";
    const _SIGNED_INIT_EVENT_PAYLOAD_CID: &str =
    ...
    const _UNSIGNED_INIT_EVENT_CID: &str =
        "bafyreiakimdaub7m6inx2nljypdhvhu5vozjhylqukif4hjxt65qnkv6my";

    const _UNSIGNED_INIT_EVENT_CAR: &str = "
    ...
    const _UNSIGNED_INIT_EVENT_PAYLOAD: &str = "uomRkYXRh9mZoZWFkZXKkY3NlcGVtb2RlbGVtb2RlbFgozgECAYUBEiCEdMdFjHF5BeBz1DotQlV6XNbluevD1NaCgEmUEg5W12Z1bmlxdWVHZm9vfGJhcmtjb250cm9sbGVyc4F4OGRpZDprZXk6ejZNa3RDRlJjd0xSRlFBOVdiZURSTTdXN2tiQmRaVEhRMnhuUGd5eFpMcTFnQ3BL";

    // Data Event for a stream with a signed init event
    const _DATA_EVENT_CAR: &str = "
    ...
    const _DATA_EVENT_CAR_UNSIGNED_INIT: &str = "
